                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            backgroundColor: _goals[index]['color'] as Color?,
                            child: Icon(
                              _goals[index]['icon'] as IconData?,
                              color: Colors.white,
                            ),
                          ),
                          title: Text(
                            _goals[index]['text'] as String,
                            style: TextStyle(
                              color:
                                  _selectedGoalIndex == index
                                      ? Colors.black
                          ...
                          trailing:
                              _selectedGoalIndex == index
                                  ? Icon(
                                    Icons.check_circle,
                                    color: _goals[index]['color'] as Color?,
                                  )
                                  : null,
                        ),
                      ),
