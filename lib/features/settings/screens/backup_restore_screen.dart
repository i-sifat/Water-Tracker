                  ...
                  child: Column(
                    children: [
                      SwitchListTile(
                        ...
                        onChanged:
                            (value) => settingsProvider.toggleAutoBackup(
                              enabled: value,
                            ),
                      ...
                      if (dataManagement.autoBackupEnabled) ...[
                        ...
                        ListTile(
                          ...
                          onTap:
                              () =>
                                  _showBackupFrequencyDialog(settingsProvider),
                        ),
                      ],
                    ],
                  ),
              ...
              children:
                  BackupFrequency.values.map((frequency) {
                    return RadioListTile<BackupFrequency>(
                      ...
                      value: frequency,
                      groupValue:
                          settingsProvider.dataManagement.backupFrequency,
                      onChanged: (value) {
                        if (value != null) {
                      ...
                      children: [
                        Expanded(
                          child: SecondaryButton(
                            text: 'Sync Settings',
                            onPressed:
                                () => _showSyncSettingsDialog(settingsProvider),
                          ),
                        ),
                        ...
                        Expanded(
                          child: PrimaryButton(
                            text: 'Sync Now',
                            onPressed:
                                (_syncStatus['isSyncing'] as bool? ?? false) ==
                                        true
                                    ? null
                                    : () =>
