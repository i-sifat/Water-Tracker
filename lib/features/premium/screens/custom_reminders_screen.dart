...
class _ReminderDialogState extends State<_ReminderDialog> {
  ...
  Widget _buildTimeSelector() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Time', style: AppTypography.subtitle),
  ...
  Widget _buildTitleField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Title', style: AppTypography.subtitle),
        const SizedBox(height: 8),
        TextField(
  ...
  Widget _buildBodyField() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Message', style: AppTypography.subtitle),
        const SizedBox(height: 8),
        TextField(
  ...
  Widget _buildDaySelector() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('Days', style: AppTypography.subtitle),
        const SizedBox(height: 8),
        Wrap(
          spacing: 8,
