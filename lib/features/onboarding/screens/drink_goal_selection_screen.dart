...
class DrinkGoalSelectionScreen extends StatefulWidget {
  ...
  @override
  State<DrinkGoalSelectionScreen> createState() =>
      _DrinkGoalSelectionScreenState();
}
...
class _DrinkGoalSelectionScreenState extends State<DrinkGoalSelectionScreen> {
  ...
  final List<double> _imperialGoals = [
    34.0,
    51.0,
    68.0,
    85.0,
  ...
  Future<void> _onContinuePressed(OnboardingProvider provider) async {
    if (_selectedGoal != null) {
      // Save the selected goal to user profile
      // Convert to liters if imperial was selected
      final goalInLiters = _useMetric ? _selectedGoal! : _selectedGoal! / 33.814;
      ...
      builder: (context, onboardingProvider, child) {
        return WillPopScope(
          ...
          child: OnboardingScreenWrapper(
            ...
            onContinue:
                _selectedGoal != null
                    ? () => _onContinuePressed(onboardingProvider)
                    : null,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Title
                  const Text('DRINK GOAL', style: AppTypography.headline),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildGoalCard(
                        goal.toStringAsFixed(
                          goal.truncateToDouble() == goal ? 0 : 1,
                        ),
                        goal,
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color:
                isSelected
                    ? AppColors.lightBlue
                    : AppColors.textSubtitle.withValues(alpha: 0.2),
