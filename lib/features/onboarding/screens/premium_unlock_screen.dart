...
class _PremiumUnlockScreenState extends State<PremiumUnlockScreen>
            ...
            child: Stack(
              ...
              children: [
                ...
                const Positioned(
                  right: 30,
                  bottom: 0,
                  child: Icon(Icons.trending_up, size: 20, color: Colors.orange),
                ),
              ],
            ),
          ),
  ...
  Widget _buildPricingPlans() {
    return Column(
      children: _pricingPlans.asMap().entries.map((entry) {
        final index = entry.key;
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: isSelected 
                      ? AppColors.waterFull 
                      : (isRecommended ? AppColors.waterFull : AppColors.unselectedBorder),
                  width: isSelected ? 2 : 1,
                ),
                boxShadow: isRecommended ? [
                  BoxShadow(
                    color: AppColors.waterFull.withValues(alpha: 0.2),
                    blurRadius: 8,
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isSelected 
                          ? AppColors.waterFull 
                          : (isRecommended ? Colors.white : Colors.transparent),
                      border: Border.all(
                        color: isSelected 
                            ? AppColors.waterFull 
                            : (isRecommended ? Colors.white : AppColors.unselectedBorder),
                        width: 2,
                      ),
                    ),
                    child: isSelected
                          ...
                          children: [
                            Text(
                              ...
                              style: TextStyle(
                                ...
                                color: isRecommended ? Colors.white : AppColors.textHeadline,
                              ),
                            ),
                            if (plan['badge'] != null) ...[
