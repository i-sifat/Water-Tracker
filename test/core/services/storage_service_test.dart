  ...
  group('StorageService', () {
    ...
    group('basic string operations', () {
      test('should save and retrieve string values', () async {
        ...
        final saveResult = await storageService.saveString(key, value, encrypted: false);
        expect(saveResult, isTrue);
        
        final retrievedValue = await storageService.getString(key, encrypted: false);
    ...
    group('storage statistics', () {
      test('should provide storage statistics', () async {
        // Add some test data
        await storageService.saveString('test_key_1', 'value1', encrypted: false);
    ...
    group('clear operations', () {
      test('should clear all data', () async {
        ...
        // Verify data exists
        final value1 = await storageService.getString('test_key_1', encrypted: false);
        ...
        // Verify data is gone
        final value1After = await storageService.getString('test_key_1', encrypted: false);
    ...
    group('backup operations', () {
      test('should create backup', () async {
        // Add some test data
        await storageService.saveString('backup_test_1', 'value1', encrypted: false);
    ...
    group('error handling', () {
      test('should handle invalid JSON gracefully', () async {
        ...
        await storageService.saveString(key, 'invalid json {', encrypted: false);
      ...
      test('should handle storage errors gracefully', () async {
        ...
        final saveResult = await storageService.saveString(longKey, 'value', encrypted: false);
        expect(saveResult, isA<bool>());
        
        final getValue = await storageService.getString(longKey, encrypted: false);
    ...
    group('encryption handling', () {
      ...
      test('should handle encrypted integer operations', () async {
        ...
        final saveResult = await storageService.saveInt(key, value, encrypted: true);
        expect(saveResult, isA<bool>());
        
        final retrievedValue = await storageService.getInt(key, encrypted: true);
      ...
      test('should handle encrypted boolean operations', () async {
        ...
        final saveResult = await storageService.saveBool(key, value, encrypted: true);
        expect(saveResult, isA<bool>());
        
        final retrievedValue = await storageService.getBool(key, encrypted: true);
