  ...
  group('PremiumService', () {
    ...
    group('generateDeviceCode', () {
      test('should generate a properly formatted device code', () async {
        ...
        expect(deviceCode, matches(RegExp(r'^[A-F0-9]{3}-[A-F0-9]{3}-[A-F0-9]{3}-[A-F0-9]{3}$')));
      });
    ...
    group('validateUnlockCode', () {
      test('should validate correct unlock code', () async {
        ...
        final isValid = await premiumService.validateUnlockCode('TEST-CODE-1234-5678');
      ...
      test('should be case insensitive', () async {
        ...
        final isValid1 = await premiumService.validateUnlockCode(testCode.toLowerCase());
        final isValid2 = await premiumService.validateUnlockCode(testCode.toUpperCase());
    ...
    group('unlockPremium', () {
      test('should unlock premium with valid code', () async {
        ...
        final validUnlockCode = '${code.substring(0, 4)}-${code.substring(4, 8)}-${code.substring(8, 12)}-${code.substring(12, 16)}';
    ...
    group('submitDonationProof', () {
      ...
      test('should include additional message in email', () async {
        ...
        expect(
          () => premiumService.submitDonationProof(additionalMessage: additionalMessage),
          returnsNormally,
        );
      });
    });
    ...
    group('resetPremiumStatus', () {
      test('should reset premium status', () async {
        ...
        await prefs.setInt('unlock_timestamp', DateTime.now().millisecondsSinceEpoch);
    ...
    group('getPremiumInfo', () {
      ...
      test('should include unlock timestamp when premium is unlocked', () async {
    ...
    group('error handling', () {
      test('should handle SharedPreferences errors gracefully', () async {
        ...
        expect(() => premiumService.unlockPremium('TEST-CODE'), returnsNormally);
