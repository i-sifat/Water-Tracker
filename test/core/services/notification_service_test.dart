...
void main() {
  ...
  group('NotificationService', () {
    ...
    group('smart reminders', () {
      ...
      test('should handle scheduling when notifications are disabled', () async {
        await notificationService.initialize();
    ...
    group('custom reminders (premium features)', () {
      ...
      test('should return empty list for custom reminders without premium', () async {
        await notificationService.initialize();
    ...
    group('usage pattern tracking', () {
      ...
      test('should calculate preferred times from recent intake hours', () async {
        await notificationService.initialize();
        
        // Simulate frequent intake at certain hours
        final recentHours = [8, 8, 8, 12, 12, 16, 20]; // 8 AM appears most frequently
    ...
    group('legacy compatibility', () {
      test('should support legacy scheduleWaterReminder method', () async {
        ...
        expect(() => notificationService.scheduleWaterReminder(), returnsNormally);
      });
    });
    ...
    group('error handling', () {
      ...
      test('should handle settings update errors gracefully', () async {
        ...
        expect(
          () => notificationService.updateNotificationSettings(startHour: 25), // Invalid hour
          returnsNormally,
        );
      });
    ...
    group('storage integration', () {
      ...
      test('should handle storage errors gracefully', () async {
        ...
        expect(() => notificationService.updateUsagePattern(lastIntakeHour: 12), returnsNormally);
        expect(() => notificationService.getNotificationSettings(), returnsNormally);
      });
    });
  });
}