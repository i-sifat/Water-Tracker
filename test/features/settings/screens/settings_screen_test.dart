...
void main() {
  group('SettingsScreen Widget Tests', () {
    ...
    testWidgets('has custom bottom navigation bar', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('contains list view for settings options', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('has notification settings option', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('has accessibility settings option', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('settings options are interactive', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('consumes settings provider correctly', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('has switch widgets for toggle settings', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('bottom navigation is at correct index', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
      ...
      expect(
        bottomNav.selectedIndex,
        equals(2),
      ); // Settings is typically index 2
    });

    testWidgets('has leading icons for settings options', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('has trailing icons for navigation', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
