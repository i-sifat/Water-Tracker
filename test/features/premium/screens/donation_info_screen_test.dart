...
void main() {
  group('DonationInfoScreen Widget Tests', () {
    ...
    testWidgets('has submit donation proof button', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('consumes premium provider correctly', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('displays donation amount information', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('has copy device code functionality', (
      WidgetTester tester,
    ) async {
      await tester.pumpWidget(createTestWidget());
