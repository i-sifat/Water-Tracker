...
void main() {
  group('AgeSelectionScreen Widget Tests', () {
    ...
    testWidgets('has custom ruler picker for age selection', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
      
      expect(find.byType(CustomRulerPicker), findsOneWidget);
    });

    testWidgets('ruler picker has appropriate age range', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('continue button is initially enabled', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
      
      final continueButton = tester.widget<ContinueButton>(find.byType(ContinueButton));
    ...
    testWidgets('continue button navigates when pressed', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('displays current selected age', (WidgetTester tester) async {
      ...
      expect(find.textContaining('25'), findsWidgets); // Default age might be 25
    });
    ...
    testWidgets('consumes onboarding provider correctly', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
    ...
    testWidgets('age display updates with selection', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
